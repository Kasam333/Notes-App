...
public class CreateNoteActivity extends AppCompatActivity {
    ...
    private ImageView imageNote, savePdfBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        increase = findViewById(R.id.bt_increase);
        decrease = findViewById(R.id.bt_decrease);
        ...
        increase.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                inputNoteText.setTextSize(TypedValue.COMPLEX_UNIT_SP, ourFontsize);
            }
        });
        ...
        savePdfBtn = findViewById(R.id.imageSavePdf);
    ...
    private void initMiscellaneous(){
        final LinearLayout layoutMiscellaneous = findViewById(R.id.layoutMiscellneous);
        final BottomSheetBehavior<LinearLayout> bottomSheetBehavior = BottomSheetBehavior.from(layoutMiscellaneous);
        layoutMiscellaneous.findViewById(R.id.textMiscellneous).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
